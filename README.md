...
- `BUCKET`: The name of the S3 bucket used for storing Terraform state files.
- `TFSTATE_FILE`: The path to the Terraform state file.
- `DB_TABLE`: The name of the DynamoDB table used for Terraform state locking.
...
- `INFRACOST_API_KEY`: API key for Infracost to estimate infrastructure costs.
